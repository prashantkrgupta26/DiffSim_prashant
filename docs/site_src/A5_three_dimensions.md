# A5 — Going 3-D: the same code, a different economy

LEARNING OUTCOME. You can run every A-track idea in three dimensions by
...
BACKGROUND. The whole stack is written over k-D octrees (this library also
...
Run:  python tutorials/A_foundations/A5_three_dimensions.py

??? example "Full script — `tutorials/A_foundations/A5_three_dimensions.py` (run it!)"
