...
Two separate LU factorizations: $\approx 1.7t$~ms.  Ratio $> 1.5\times$
...
E0b & factorization reuse ratio       & $> 1.5\times$  & $> 1.5\times$ \\
E0b & misfit drop (100 GD steps)      & $> 100\times$  & $> 100\times$ \\
\midrule
...
\texttt{docs/site\_src/theory/}\linebreak\texttt{adjoint\_readiness\_checklist.md} (T4).
