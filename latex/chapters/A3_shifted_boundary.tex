\chapter{Immersed geometry: the Shifted Boundary Method}
\label{ch:A3_shifted_boundary}
\noindent\texttt{tutorials/A\_foundations/A3\_shifted\_boundary.py}\\[0.75em]
\begin{outcome}
You can solve a PDE on a domain that has NO body-fitted
...
point on the circle:
    ...
    S u = u + grad(u).d          (+ half d\textasciicircum{}T H(u) d for quadratic elements)
...
\begin{expected}
\begin{verbatim}
errors ~ 3.2e-3 / 6.6e-4 / 1.5e-4, orders 2.28 / 2.13
