"""Standardized run harness every NS-SBM module ``run.py`` adopts.
...
# CLI
# --------------------------------------------------------------------------
def build_parser(description="NS-SBM tutorial", parents=None):
...
def run_tutorial(run_fn, schema=None, args=None, description="NS-SBM tutorial",
